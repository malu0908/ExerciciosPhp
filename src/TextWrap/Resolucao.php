...
/**
 *
 * Código responsável por dividir uma string em um 
 * array de substrings de tamanho máximo informado
 * por parâmetro
 *
 */
class Resolucao implements TextWrapInterface {
   ...
   * @param text informa a string a ser dividida em substrings
   * @param length informa o tamanho máximo de cada substring 
   *
   */
